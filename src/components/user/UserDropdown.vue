<template>
  <div class="user-dropdown" ref="dropdownRef">
    <button @click="toggleDropdown" class="user-dropdown__trigger">
      <img v-if="user.avatar" :src="user.avatar" :alt="user.name" class="user-dropdown__avatar" />
    ...
    <Transition name="dropdown">
      <div v-if="isOpen" class="user-dropdown__menu">
        ...
        <router-link to="/profile" @click="closeDropdown" class="user-dropdown__item">
          <font-awesome-icon :icon="['fas', 'user']" />
          Meu Perfil
        </router-link>

        <router-link to="/my-ratings" @click="closeDropdown" class="user-dropdown__item">
          <font-awesome-icon :icon="['fas', 'star']" />
          Minhas Avaliações
        </router-link>

        <router-link to="/favorites" @click="closeDropdown" class="user-dropdown__item">
